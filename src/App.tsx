...
// Navigation sections
type SectionName = 'hut' | 'music' | 'vibrate' | 'tribe' | 'bts' | 'store' | 'live' | 'fanart' | 'booking' | 'admin';
    ...
    >
        ...
        <div className="w-full flex justify-between items-center px-6">
          ...
          <nav className="flex gap-6 text-xl font-bold text-white">
            ...
            <button 
              ...
              className={`hover:underline ${activeSection === 'fanart' ? 'underline' : ''}`}
            >
              FAN ART
            </button>
            <button 
              onClick={() => setActiveSection('booking')} 
              className={`hover:underline ${activeSection === 'booking' ? 'underline' : ''}`}
            >
              BOOKING
            </button>
          </nav>
      ...
      <main className="flex-grow flex items-center justify-center">
        ...
        {activeSection === 'bts' && (
          ...
          <div className="text-center text-white p-8 bg-black bg-opacity-60 rounded-lg max-w-6xl w-full">
