# Red Lotus Admin Login Setup Guide
...
#### Option 1: Use the Pre-Configured Setup Script (Recommended)

1. Run the setup script in your project directory:
   - Windows: `.\setup-firebase-configured.ps1`
   - Mac/Linux: `bash setup-firebase-configured.sh`
